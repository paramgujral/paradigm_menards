...
async function doorCustomConfigure(page) {
  ...
  //await page.goto('https://menardsdev.wtsparadigm.com/quotes/cf69d19b-da00-4839-8e87-0c59924d0e93/configure/product-select/MenardsPatioDoorParts');
  test.setTimeout(2 * 60 * 1000);
  await verifyDesignActive(page)
  //With Nailing Flange
  // Click text=Back
  await page.locator('text=Back').click();
  // await page.waitForURL('https://menardsdev.wtsparadigm.com/quotes/cf69d19b-da00-4839-8e87-0c59924d0e93/configure/product-select/MenardsPatioDoors');
  // Click text=Custom Patio Door PartsSelectReplacement glass, panels, frames, screens and more >> a
